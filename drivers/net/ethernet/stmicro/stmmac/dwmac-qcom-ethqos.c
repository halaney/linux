...
static int ethqos_rgmii_macro_init(struct qcom_ethqos *ethqos)
{
	...
	case SPEED_1000:
		...
		/* TODO: be nice to mention whatever the delay is but ive got no clue */
		if (ethqos->has_emac3)
	...
	case SPEED_100:
		...
		rgmii_updatel(ethqos, RGMII_CONFIG2_DATA_DIVIDE_CLK_SEL,
			      0, RGMII_IO_MACRO_CONFIG2);
		if (1) // Downstream does mac2mac || marvell phy so probably board level
		//if (ethqos->has_emac3)
			rgmii_updatel(ethqos,
					  RGMII_CONFIG2_TX_CLK_PHASE_SHIFT_EN,
					  0, RGMII_IO_MACRO_CONFIG2);
	...
	case SPEED_10:
		...
		if (0) // downstream has if !emac3 || mac2mac || marvell phy
			rgmii_updatel(ethqos,
				      RGMII_CONFIG2_TX_CLK_PHASE_SHIFT_EN,
				      RGMII_CONFIG2_TX_CLK_PHASE_SHIFT_EN,
				      RGMII_IO_MACRO_CONFIG2);
...
/* TODO: think about the below as it was added upstream and might affect me */
...
static int qcom_ethqos_remove(struct platform_device *pdev)
{
	...
	/* TODO: did this come from downstream patches or old upstream stuff.. */
