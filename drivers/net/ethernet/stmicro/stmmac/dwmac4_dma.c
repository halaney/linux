...
static void do_dma_init_rx_chan(void __iomem *ioaddr, int rx_ctl_offset,
				int rx_high_offset, int rx_base_offset,
...
static void do_dma_init_tx_chan(void __iomem *ioaddr, int tx_ctl_offset,
				int tx_high_offset, int tx_base_offset,
				struct stmmac_dma_cfg *dma_cfg,
...
static void do_dma_init_channel(void __iomem *ioaddr,
				struct stmmac_dma_cfg *dma_cfg,
				int addr_offset, int intr_addr_offset,
				int intr_addr_mask)
{
	u32 value;
...
static void do_enable_tso(void __iomem *ioaddr, bool en, int addr_offset)
{
...
static void do_qmode(void __iomem *ioaddr, u8 qmode, int addr_offset)
{
	u32 mtl_tx_op = readl(ioaddr + addr_offset);
...
static void do_set_bfsize(void __iomem *ioaddr, int bfsize, int addr_offset)
{
	u32 value = readl(ioaddr + addr_offset);
...
static void do_enable_sph(void __iomem *ioaddr, bool en, int addr_offset)
{
...
static int do_enable_tbs(void __iomem *ioaddr, bool en, int addr_offset)
{
	u32 value = readl(ioaddr + addr_offset);
