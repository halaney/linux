...
static struct platform_driver disp_cc_0_sa8775p_driver = {
	...
	.driver = {
		.name = "disp_cc_0-sa8775p",
		.of_match_table = disp_cc_0_sa8775p_match_table,
	},
};

static int __init disp_cc_0_sa8775p_init(void)
{
	return platform_driver_register(&disp_cc_0_sa8775p_driver);
}
subsys_initcall(disp_cc_0_sa8775p_init);

static void __exit disp_cc_0_sa8775p_exit(void)
{
	platform_driver_unregister(&disp_cc_0_sa8775p_driver);
}
module_exit(disp_cc_0_sa8775p_exit);

MODULE_DESCRIPTION("Qualcomm SA8775P DISP_CC_0 driver");
MODULE_LICENSE("GPL");
