...
#include <dt-bindings/clock/qcom,videocc-sa8775p.h>
...
static struct platform_driver video_cc_sa8775p_driver = {
	...
	.driver = {
		.name = "video_cc-sa8775p",
		.of_match_table = video_cc_sa8775p_match_table,
	},
};

static int __init video_cc_sa8775p_init(void)
{
	return platform_driver_register(&video_cc_sa8775p_driver);
}
subsys_initcall(video_cc_sa8775p_init);

static void __exit video_cc_sa8775p_exit(void)
{
	platform_driver_unregister(&video_cc_sa8775p_driver);
}
module_exit(video_cc_sa8775p_exit);

MODULE_DESCRIPTION("Qualcomm SA8775P VIDEO_CC driver");
MODULE_LICENSE("GPL");
