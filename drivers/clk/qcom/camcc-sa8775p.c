...
static int __init cam_cc_sa8775p_init(void)
{
	return platform_driver_register(&cam_cc_sa8775p_driver);
}
subsys_initcall(cam_cc_sa8775p_init);

static void __exit cam_cc_sa8775p_exit(void)
{
	platform_driver_unregister(&cam_cc_sa8775p_driver);
}
module_exit(cam_cc_sa8775p_exit);

MODULE_DESCRIPTION("Qualcomm SA8775P CAM_CC driver");
MODULE_LICENSE("GPL");
