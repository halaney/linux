...
#include <dt-bindings/clock/qcom,dispcc-sa8775p.h>
...
static struct gdsc *disp_cc_1_sa8775p_gdscs[] = {
	...
	[MDSS_CORE_INT2_GDSC] = &mdss_core_int2_gdsc,
};
...
static struct platform_driver disp_cc_1_sa8775p_driver = {
	...
	.driver = {
		.name = "disp_cc_1-sa8775p",
		.of_match_table = disp_cc_1_sa8775p_match_table,
	},
};

static int __init disp_cc_1_sa8775p_init(void)
{
	return platform_driver_register(&disp_cc_1_sa8775p_driver);
}
subsys_initcall(disp_cc_1_sa8775p_init);

static void __exit disp_cc_1_sa8775p_exit(void)
{
	platform_driver_unregister(&disp_cc_1_sa8775p_driver);
}
module_exit(disp_cc_1_sa8775p_exit);

MODULE_DESCRIPTION("Qualcomm SA8775P DISP_CC_1 driver");
MODULE_LICENSE("GPL");
